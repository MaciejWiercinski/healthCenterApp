INSERT INTO Doctors (name, surname, pesel, specialty)
VALUES
    ('Dr. John', 'Smith', '12345678901', 'Cardiology'),
    ('Dr. Emily', 'Johnson', '23456789012', 'Pediatrics'),
    ('Dr. Michael', 'Brown', '34567890123', 'Neurology');

INSERT INTO Patients (name, surname, pesel, contact_info)
VALUES
    ('Alice', 'Johnson', '45678901234', 'alice@example.com'),
...
VALUES
    ('45678901234', 'Hypertension', 'Medication A, Exercise', '2023-08-02'),
